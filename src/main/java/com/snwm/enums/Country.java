...
public enum Country {
        ...
        BULGARIA("bg",
                        Arrays.asList(Operator.A1, Operator.BULSATCOM, Operator.MAX_TELECOM, Operator.TELENOR,
                                        Operator.VIVACOM)),
        CZECH_REPUBLIC("cz",
                        Arrays.asList(Operator.NORDIC_TELECOM, Operator.O2, Operator.SZDC, Operator.TMOBILE,
                                        Operator.VODAFONE)),
        ...
        HONG_KONG("hk",
                        Arrays.asList(Operator.CHINA_MOBILE, Operator.CSL, Operator.PCCW, Operator.SMARTONE,
                                        Operator.THREE)),
        INDONESIA("id",
                        Arrays.asList(Operator.AXIS, Operator.INDOSAT, Operator.SMARTFREN, Operator.TELKOMSEL,
                                        Operator.THREE)),
        KAZAKHSTAN("kz",
                        Arrays.asList(Operator.ACTIV, Operator.ALTEL, Operator.BEELINE, Operator.FORTE_MOBILE,
                                        Operator.TELE2)),
        KENYA("ke", Arrays.asList(Operator.AIRTEL, Operator.ECONET, Operator.ORANGE, Operator.SAFARICOM,
                        Operator.TELKOM)),
        ...
        MALAYSIA("my",
                        Arrays.asList(Operator.CELCOM, Operator.DIGI, Operator.ELECTCOMS, Operator.INDOSAT,
                                        Operator.MAXIS,
        ...
        PAKISTAN("pk",
                        Arrays.asList(Operator.CHARJI, Operator.JAZZ, Operator.SCO_MOBILE, Operator.TELENOR,
                                        Operator.UFONE,
                                        Operator.ZONG)),
        ...
        RUSSIA("ru",
                        Arrays.asList(Operator.BEELINE, Operator.LYCAMOBILE, Operator.MEGAFON, Operator.MTS,
                                        Operator.TELE2,
                                        Operator.MTT, Operator.PATRIOT, Operator.ROSTELECOM, Operator.TINKOFF,
                                        Operator.VECTOR,
        ...
        UZBEKISTAN("uz",
                        Arrays.asList(Operator.BEELINE, Operator.PERFECTUM, Operator.UCELL, Operator.UMS,
                                        Operator.UZMOBILE)),
